...
export function getSkillHubSources(profile?: ProfileScope): Promise<SkillHubSourcesResponse> {
...
export function getSkillHubConfig(profile?: ProfileScope): Promise<SkillHubConfigResponse> {
...
export function saveSkillHubConfig(
  config: SkillHubConfigResponse,
  profile?: ProfileScope
): Promise<SkillHubConfigResponse & { ok: boolean }> {
...
export function testSkillHubSource(
  source: EnterpriseSkillHubSourceConfig,
  profile?: ProfileScope
): Promise<SkillHubSourceProbeResponse> {
