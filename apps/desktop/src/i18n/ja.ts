...
export const ja = defineLocale({
  ...
  skills: {
    ...
    hub: {
      manageSources: 'スキルソースを管理',
      privateMode: '社内ネットワークのみ',
      sources: {
        title: 'スキルハブのソース',
        subtitle: '企業ソースはプロファイルごとに保存されます。',
        networkMode: 'ネットワークモード',
        modePublic: '公開のみ',
        modeHybrid: '公開 + 企業',
        modePrivate: '企業のみ',
        privateModeActive: '公開レジストリは無効です。ローカルのオプションスキルは利用できます。',
        enterpriseSources: '企業ソース',
        add: 'ソースを追加',
        update: 'ソースを更新',
        edit: 'ソースを編集',
        remove: 'ソースを削除',
        none: '企業ソースは設定されていません。',
        name: '名前',
        namePlaceholder: '企業スキルハブ',
        protocol: 'レジストリプロトコル',
        protocolWellKnown: 'Well-known',
        protocolClawHub: 'ClawHub 互換',
        indexUrl: 'インデックス URL',
        registryUrl: 'レジストリ URL',
        tokenEnv: 'トークン環境変数',
        caBundle: 'CA バンドルのパス',
        allowPrivate: 'このソースのプライベートネットワーク接続を許可',
        optional: '任意',
        test: '接続をテスト',
        online: count => `オンライン · ${count} スキル`,
        cached: count => `キャッシュを使用 · ${count} スキル`,
        unreachable: 'ソースに接続できません',
        retry: '再試行',
        cancel: 'キャンセル',
        save: '保存',
        saving: '保存中...',
        saved: 'スキルハブのソースを保存しました。',
        loadFailed: 'スキルハブのソース設定を読み込めませんでした。',
        saveFailed: 'スキルハブのソースを保存できませんでした',
        testFailed: 'スキルハブの接続テストに失敗しました',
        nameRequired: 'ソース名を入力してください。',
        urlInvalid: '認証情報を含まない有効な HTTP または HTTPS URL を入力してください。',
        tokenEnvInvalid: '有効な環境変数名を入力してください。'
      }
    }
  },
