...
export const zh: Translations = {
  ...
  skills: {
    ...
    hub: {
      ...
      manageSources: '管理技能来源',
      privateMode: '仅企业内网',
      sources: {
        title: '技能中心来源',
        subtitle: '企业来源按当前配置档案独立保存。',
        networkMode: '网络模式',
        modePublic: '仅公共来源',
        modeHybrid: '公共 + 企业',
        modePrivate: '仅企业内网',
        privateModeActive: '公共技能库已停用，本地可选技能仍可使用。',
        ...
        none: '尚未配置企业来源。',
        name: '名称',
        namePlaceholder: '企业技能中心',
        protocol: '仓库协议',
        protocolWellKnown: 'Well-known',
        protocolClawHub: 'ClawHub 兼容',
        indexUrl: '索引地址',
        registryUrl: '仓库地址',
        tokenEnv: '令牌环境变量',
        caBundle: 'CA 证书路径',
        allowPrivate: '允许此来源访问内网地址',
        optional: '可选',
        test: '测试连接',
        online: count => `连接正常 · ${count} 个技能`,
        cached: count => `使用缓存索引 · ${count} 个技能`,
        unreachable: '来源不可达',
        retry: '重试',
        cancel: '取消',
        save: '保存',
        saving: '保存中…',
        saved: '技能中心来源已保存。',
        loadFailed: '无法加载技能中心来源设置。',
        saveFailed: '无法保存技能中心来源',
        testFailed: '技能中心连接测试失败',
        nameRequired: '请输入来源名称。',
        urlInvalid: '请输入不含嵌入凭据的有效 HTTP 或 HTTPS 地址。',
        tokenEnvInvalid: '请输入有效的环境变量名。'
      }
    }
  },
