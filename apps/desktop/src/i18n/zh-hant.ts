...
export const zhHant = defineLocale({
  ...
  skills: {
    ...
    hub: {
      manageSources: '管理技能來源',
      privateMode: '僅企業內網',
      sources: {
        title: '技能中心來源',
        subtitle: '企業來源依目前設定檔獨立儲存。',
        networkMode: '網路模式',
        modePublic: '僅公共來源',
        modeHybrid: '公共 + 企業',
        modePrivate: '僅企業內網',
        privateModeActive: '公共技能庫已停用，本機可選技能仍可使用。',
        enterpriseSources: '企業來源',
        add: '新增來源',
        update: '更新來源',
        edit: '編輯來源',
        remove: '移除來源',
        none: '尚未設定企業來源。',
        name: '名稱',
        namePlaceholder: '企業技能中心',
        protocol: '倉庫協定',
        protocolWellKnown: 'Well-known',
        protocolClawHub: 'ClawHub 相容',
        indexUrl: '索引網址',
        registryUrl: '倉庫網址',
        tokenEnv: '權杖環境變數',
        caBundle: 'CA 憑證路徑',
        allowPrivate: '允許此來源存取內網位址',
        optional: '選填',
        test: '測試連線',
        online: count => `連線正常 · ${count} 個技能`,
        cached: count => `使用快取索引 · ${count} 個技能`,
        unreachable: '來源無法連線',
        retry: '重試',
        cancel: '取消',
        save: '儲存',
        saving: '儲存中…',
        saved: '技能中心來源已儲存。',
        loadFailed: '無法載入技能中心來源設定。',
        saveFailed: '無法儲存技能中心來源',
        testFailed: '技能中心連線測試失敗',
        nameRequired: '請輸入來源名稱。',
        urlInvalid: '請輸入不含內嵌憑證的有效 HTTP 或 HTTPS 網址。',
        tokenEnvInvalid: '請輸入有效的環境變數名稱。'
      }
    }
  },
