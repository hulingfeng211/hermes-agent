...
export const ar = defineLocale({
  ...
  skills: {
    ...
    hub: {
      manageSources: 'إدارة مصادر المهارات',
      privateMode: 'الشبكة الداخلية فقط',
      sources: {
        title: 'مصادر مركز المهارات',
        subtitle: 'تُحفظ مصادر المؤسسة لكل ملف تعريف.',
        networkMode: 'وضع الشبكة',
        modePublic: 'عام فقط',
        modeHybrid: 'عام + مؤسسة',
        modePrivate: 'المؤسسة فقط',
        privateModeActive: 'المصادر العامة معطلة. تبقى المهارات المحلية متاحة.',
        enterpriseSources: 'مصادر المؤسسة',
        add: 'إضافة مصدر',
        update: 'تحديث المصدر',
        edit: 'تعديل المصدر',
        remove: 'إزالة المصدر',
        none: 'لا توجد مصادر مؤسسة مضبوطة.',
        name: 'الاسم',
        namePlaceholder: 'مركز مهارات المؤسسة',
        protocol: 'بروتوكول السجل',
        protocolWellKnown: 'Well-known',
        protocolClawHub: 'متوافق مع ClawHub',
        indexUrl: 'رابط الفهرس',
        registryUrl: 'رابط السجل',
        tokenEnv: 'متغير بيئة الرمز',
        caBundle: 'مسار شهادة CA',
        allowPrivate: 'السماح لهذا المصدر بعناوين الشبكة الداخلية',
        optional: 'اختياري',
        test: 'اختبار الاتصال',
        online: count => `متصل · ${count} مهارة`,
        cached: count => `استخدام الفهرس المخزن · ${count} مهارة`,
        unreachable: 'المصدر غير متاح',
        retry: 'إعادة المحاولة',
        cancel: 'إلغاء',
        save: 'حفظ',
        saving: 'جار الحفظ...',
        saved: 'تم حفظ مصادر مركز المهارات.',
        loadFailed: 'تعذر تحميل إعدادات مصادر مركز المهارات.',
        saveFailed: 'تعذر حفظ مصادر مركز المهارات',
        testFailed: 'فشل اختبار اتصال مركز المهارات',
        nameRequired: 'أدخل اسم المصدر.',
        urlInvalid: 'أدخل رابط HTTP أو HTTPS صالحا من دون بيانات اعتماد مضمّنة.',
        tokenEnvInvalid: 'أدخل اسم متغير بيئة صالحا.'
      }
    }
  },
  agents: {
