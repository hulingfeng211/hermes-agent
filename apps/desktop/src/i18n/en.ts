...
export const en: Translations = {
  ...
  skills: {
    ...
    hub: {
      ...
      manageSources: 'Manage skill sources',
      privateMode: 'Private network only',
      sources: {
        title: 'Skill Hub sources',
        subtitle: 'Enterprise registries are stored per profile.',
        networkMode: 'Network mode',
        modePublic: 'Public',
        modeHybrid: 'Public + enterprise',
        modePrivate: 'Enterprise only',
        privateModeActive: 'Public registries are disabled. Local optional skills remain available.',
        enterpriseSources: 'Enterprise sources',
        add: 'Add source',
        update: 'Update source',
        edit: 'Edit source',
        remove: 'Remove source',
        none: 'No enterprise sources configured.',
        name: 'Name',
        namePlaceholder: 'Company Skill Hub',
        protocol: 'Registry protocol',
        protocolWellKnown: 'Well-known',
        protocolClawHub: 'ClawHub compatible',
        indexUrl: 'Index URL',
        registryUrl: 'Registry URL',
        tokenEnv: 'Token environment variable',
        caBundle: 'CA bundle path',
        allowPrivate: 'Allow this source on private network addresses',
        optional: 'optional',
        test: 'Test connection',
        online: count => `Online · ${count} skill${count === 1 ? '' : 's'}`,
        cached: count => `Using cached index · ${count} skill${count === 1 ? '' : 's'}`,
        unreachable: 'Source unreachable',
        retry: 'Retry',
        cancel: 'Cancel',
        save: 'Save',
        saving: 'Saving...',
        saved: 'Skill Hub sources saved.',
        loadFailed: 'Could not load Skill Hub source settings.',
        saveFailed: 'Could not save Skill Hub sources',
        testFailed: 'Skill Hub connection test failed',
        nameRequired: 'Enter a source name.',
        urlInvalid: 'Enter a valid HTTP or HTTPS URL without embedded credentials.',
        tokenEnvInvalid: 'Enter a valid environment variable name.'
      }
    }
  },
